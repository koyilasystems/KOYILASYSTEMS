...
export const postApplication = catchAsyncError(async (req, res, next) => {
  ...
  const allowedFormats = ["image/png", "image/jpeg", "image/webp", "text/plain", "application/pdf", "application/msword", "application/word", "application/doc", "Microsoft Office/word"];
